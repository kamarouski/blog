...
<html>
  <head>
    <title>Kamarouski Blog</title>
    <link href="/blog/wp-content/themes/kamarouski/style.css" rel="stylesheet" />
  ...
  <body>
    <div class="content">
      <header style="padding: 50px 0; text-align: center; color: #aaa; font-size: 14px; line-height: 1.4">
        <div>Front-End engineer from Melbourne, Australia <br /> working as Web Developer at <a style="color: #fff; text-decoration:none;" target="_blank" href="https://carsales.com.au">Carsales</a></div>
        <div>
